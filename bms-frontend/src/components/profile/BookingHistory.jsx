      ...
      <div className="px-6 rounded-md">
        ...
        {ordersData.map((order) => (
            ...
            <div className="flex items-start gap-10">
              ...
              <div className="h-40 border-1 border-gray-300 border-dashed">

              <div className="flex items-start justify-between w-full">
                <div className="flex-1">
                  <p className="font-normal text-1g">{order.title}</p>
                ...
                <div className="p-4 text-right">
                    <p className="text-sm text-gray-500">Ticket: ₹{order.ticket.toFixed(2)}
                        Convenience Fees: ₹{order.fee.toFixed(2)}  </p>
                ...
                <div>
                    <p className="font-semibold">Booking Data & Time</p>  
